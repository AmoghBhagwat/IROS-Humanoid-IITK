...
class EllipsoidGaitGenerator():
    ...
    def __init__(self, robot, time_step):
        ...
        self.in_place_step_length = 0.01 # when turning in place
        self.step_height = 0.001 # height of the ellipsoid path
        self.step_penetration = 0.002  # depth of the ellipsoid path
